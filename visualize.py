...
from visualize_kit.kitti_utils import load_kitti_calib, read_objs2velo, colors_list
from visualize_kit.PointCloudVis import PointCloudVis
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data", "--d", type=str, default="dataset/kitti", help="kitti data path")
    parser.add_argument("--frame", "--f", type=int, default=5, help="frame of the data")
